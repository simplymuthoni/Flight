...
from validators import (airport_args, airplane_args, flight_args)
from helpers.query_helpers import (generate_response, save_airport, save_airplane, save_flight)
...
class AirportManipulation(MethodView):
    ...
    def post(self, name, country, city):
        ...
        current_roles = get_jwt_header()['roles']
